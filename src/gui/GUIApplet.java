...
public class GUIApplet extends JApplet {
     ...
     */
    public void init( SimpleWeightedGraph<HashTag, DefaultWeightedEdge> graph) {
        ...
        for(HashTag vertex: graph.vertexSet()){
        	g.addVertex(vertex.toString());
        }
        for(DefaultWeightedEdge edge: graph.edgeSet()){
        	g.addEdge(graph.getEdgeSource(edge) , graph.getEdgeTarget(edge));
        }
